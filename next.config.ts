        ...
        headers: [
          ...
          { key: 'Permissions-Policy', value: 'camera=(), microphone=(), geolocation=(), payment=()' },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://*.supabase.co https://api.razorpay.com https://checkout.razorpay.com https://accounts.google.com",
          ...
          // ✅ Prevent browser from storing sensitive pages in cache
          { key: 'Cache-Control', value: 'no-store' },
        ],
      },
      // ✅ API routes — strict no-cache + block CORS from unknown origins
      {
        source: '/api/(.*)',
        headers: [
